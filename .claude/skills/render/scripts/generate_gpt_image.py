...
Usage:
    uv run generate_gpt_image.py "prompt" output.png [options]

Examples:
    uv run generate_gpt_image.py "A sunset over mountains" sunset.png
    uv run generate_gpt_image.py "Company logo" logo.png --size 1024x1024 --quality high
    uv run generate_gpt_image.py "Wide cinematic shot" wide.png --size 2048x1152
